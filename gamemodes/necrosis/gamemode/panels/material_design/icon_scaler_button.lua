...
function PANEL:Init()
	...
	self.IconPanel = vgui.Create("NecrosisMaterialDesignIcon", self)
	self.IconScale = 0.75
	self.IconX = 0.5
	self.IconY = 0.5
...
--post
derma.DefineControl("NecrosisMaterialDesignIconScalerButton", "Wrapper for NecrosisMaterialDesignIcon which lets you easily scale the icon inside. Also functions as a button.", PANEL, "DButton")